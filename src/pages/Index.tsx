...
import { Globe, Video, Image as ImageIcon, Headphones, ArrowRight } from "lucide-react";
...
const Index = () => {
  ...
  const services = [
    ...
    },
    {
      icon: <Video size={24} />,
      title: "Video Editing",
      description: "Professional video editing services to help you tell your story in the most engaging way possible.",
      link: "/portfolio",
    },
    {
      icon: <ImageIcon size={24} />,
      title: "Graphic Design",
      description: "Eye-catching graphics and visuals that communicate your brand's message effectively.",
      link: "/portfolio",
    },
    {
      icon: <Headphones size={24} />,
      title: "Audio Production",
      description: "High-quality audio production and dubbing services to enhance your content.",
      link: "/portfolio",
    },
  ];
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-600">
              Take a look at some of our recent work across various creative disciplines.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600">
                We combine creativity with technical expertise to deliver solutions that not only look great but also achieve your business objectives.
              </p>
              ...
              <div className="space-y-4 pt-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-cre8ive-teal">Creative Expertise</h3>
                    <p className="text-gray-600 text-sm">Our team of creative professionals brings years of experience across various disciplines.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-cre8ive-teal">Tailored Approach</h3>
                    <p className="text-gray-600 text-sm">We don't believe in one-size-fits-all solutions. Each project is customized to your specific needs.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-cre8ive-teal">Client-Focused</h3>
                    <p className="text-gray-600 text-sm">We prioritize understanding your goals and maintain clear communication throughout the process.</p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-cre8ive-teal text-white">
        <div className="container-custom text-center">
          ...
          <p className="text-white/80 max-w-2xl mx-auto mb-8">
            Let's work together to create something amazing. Contact us today to discuss your project needs.
          </p>
